...
<Dropdown
    content={props.data.tags}
    contentName='Topic'
    contentSlug='tag'
/>

<Dropdown
    content={props.data.states}
    contentName='State'
    contentSlug='state'
/>
...
query {
    stories: allAirtable(filter: {table: {eq: "Stories"}, data: {Status: {eq: "Published"}}}) {
        edges {
            node {
                id
                data {
    ...
    tags: allAirtable(filter: {table: {eq: "Stories"}, data: {Status: {eq: "Published"}}}) {
        group(field: data___Tags) {
            fieldValue
        }
    }
    states: allAirtable(filter: {table: {eq: "Stories"}, data: {Status: {eq: "Published"}}}) {
        group(field: data___State) {
            fieldValue
        }
    }
    schools: allAirtable(filter: {table: {eq: "Stories"}, data: {Status: {eq: "Published"}}}) {
